...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
  ...
  public RecipeBootstrap(CategoryRepository categoryRepository, RecipeRepository recipeRepository, UnitOfMeasureRepository unitOfMeasureRepository, SetHelper setHelper) {
  ...
  private List<Recipe> getRecipes() {
    ...
    this.setHelper.addToSet(guacRecipe, "categories", americanCategory);
    this.setHelper.addToSet(guacRecipe, "categories", mexicanCategory);
    ...
    this.setHelper.addToSet(tacosRecipe, "categories", americanCategory);
    this.setHelper.addToSet(tacosRecipe, "categories", mexicanCategory);
